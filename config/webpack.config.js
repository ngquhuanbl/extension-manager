...
module.exports = function (webpackEnv) {
  ...
  // EXTENSION WORKER WEBPACK CONFIG
  const extensionWorkerConfig = {
  ...
  // EXTENSION WORKER WEBPACK CONFIG - ENTRY
  ...
  extensionWorkerConfig.output.filename = "static/js/extension-worker.bundle.js";

  return [appConfig, extensionWorkerConfig];
};
